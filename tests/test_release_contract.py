...
def test_all_runtime_files_live_in_component() -> None:
    required = {"__init__.py", "alarm.py", "button.py", "config_flow.py", "const.py", "entity.py", "manifest.json", "media.py", "number.py", "ramp.py", "schedule.py", "select.py", "sensor.py", "services.yaml", "switch.py", "text.py", "time.py", "frontend/wekker-card.js", "translations/en.json", "translations/nl.json"}
